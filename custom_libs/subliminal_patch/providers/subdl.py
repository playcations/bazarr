    ...
    def query(self, languages, video):
        ...
        if isinstance(video, Episode):
            ...
            if self._bazarr_policy['season_fallback_enabled']:
                ...
                merge(self._cached_search(dict(base_params, type='tv', season_number=video.season),
            ...
            if not all_items and self._bazarr_policy['title_fallback_enabled']:
                ...
                merge(self._cached_search(dict(base_params, type='tv'), 'title-only')[0], 'title-only')
        else:
